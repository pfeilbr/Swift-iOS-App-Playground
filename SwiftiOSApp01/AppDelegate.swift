...
class SpriteKitPlay {
    ...
    class MyScene : SKScene {
        ...
        var message:String = ""
        var _lbl:SKLabelNode = SKLabelNode(text: "")

        override func didMoveToView(view: SKView) {
            backgroundColor = UIColor.blueColor()
            _lbl = SKLabelNode(text: self.message)
        ...
        override func touchesBegan(touches: NSSet, withEvent event: UIEvent) {
            ...
            if n == _lbl {
                ...
                _lbl.runAction(SKAction.sequence([startActn, endActn]), completion: {
                    ...
                    self.view?.presentScene(gscn, transition: SKTransition.crossFadeWithDuration(2))
                })
    ...
    class GameScene : SKScene, SKPhysicsContactDelegate {
        ...
        override func didMoveToView(view: SKView) {
            ...
            _circle.physicsBody?.categoryBitMask = CollisionType.Ball.rawValue
        ...
        func addRock() {
            ...
            rock.physicsBody?.collisionBitMask = CollisionType.Ball.rawValue
            rock.physicsBody?.contactTestBitMask = CollisionType.Ball.rawValue
            self.addChild(rock)
        }
...
class UIManager {
    ...
    func installRootVC(vc:UIViewController) {
        window.addSubview(vc.view)
        window.rootViewController = vc
    }
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: NSDictionary?) -> Bool {
        ...
        //uiMgr.installRootVC(CoreLocationPlay())
